class Config: #The parent Config class contains configurations that are used in both production and development stages. 
    ...
    NEWSSOURCE_API_BASE_URL ='https://api.newsapi.org/3/newssource/{}?api_key={}' # store the news source base URL inside the app/config file. We use the {} to represent sections in the URL that will be replaced with actual values
